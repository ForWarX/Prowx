...
<table cellspacing="1" cellpadding="3" width="100%">
  ...
  <!--<?php if ($this->_var['show_title_field'] == "1"): ?>-->
  <tr>
    <td class="label">图片标题</td>
    <td><input name="title" type="text" value="<?php echo $this->_var['rt']['title']; ?>" size="40" /></td>
  </tr>
  <!--<?php else: ?>-->
  ...
  <tr>
    ...
    <td><input name="price" type="text" value="<?php echo $this->_var['rt']['price']; ?>" size="10"/></td>
  </tr>
  <tr align="center">
    <td colspan="2">
      ...
      <input type="hidden"  name="type"       value="<?php echo $this->_var['rt']['type']; ?>" />
	  <input type="hidden"  name="position"       value="<?php echo $this->_var['rt']['position']; ?>" />
	  <input type="hidden"  name="gotoid"       value="<?php echo $this->_var['gotoid']; ?>" />
