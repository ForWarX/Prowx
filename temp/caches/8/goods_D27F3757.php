...
<title>大学城vsdf_菜园_ECSHOP演示站 - Powered by PBCC</title>
...
<div class="block box">
 <div id="ur_here">
  当前位置: <a href=".">首页</a> <code>&gt;</code> <a href="category.php?id=16">菜园</a> <code>&gt;</code> 大学城vsdf </div>
</div>
<div class="blank"></div>
<div class="block clearfix">
  ...
  <div class="AreaR">
   ...
   <div id="goodsInfo" class="clearfix">
     ...
     <div class="imgInfo">
      ...
      <img src="images/201503/goods_img/52_G_1426504543437.jpg" alt="大学城vsdf"/>
     </a>
              <div class="blank5"></div>
      ...
      <div class="gallery">
        <div id="demo">
          <div id="demo1" style="float:left">
            <ul>
                         <li><a href="gallery.php?id=52&amp;img=60" target="_blank"><img src="images/201503/thumb_img/52_thumb_P_1426504532974.jpg" alt="大学城vsdf" class="B_blue" /></a>
            </li>
                        <li><a href="gallery.php?id=52&amp;img=61" target="_blank"><img src="images/201503/thumb_img/52_thumb_P_1426504543912.jpg" alt="大学城vsdf" class="B_blue" /></a>
            </li>
                        <li><a href="gallery.php?id=52&amp;img=62" target="_blank"><img src="images/201504/thumb_img/52_thumb_P_1427956585240.jpg" alt="大学城vsdf" class="B_blue" /></a>
            </li>
                        <li><a href="gallery.php?id=52&amp;img=63" target="_blank"><img src="images/201504/thumb_img/52_thumb_P_1427956585201.jpg" alt="大学城vsdf" class="B_blue" /></a>
            </li>
                        <li><a href="gallery.php?id=52&amp;img=64" target="_blank"><img src="images/201504/thumb_img/52_thumb_P_1427956586233.jpg" alt="大学城vsdf" class="B_blue" /></a>
            </li>
                        </ul>
          </div>
     ...
     <div class="clearfix">
      <p class="f_l">大学城vsdf</p>
      <p class="f_r">
                  <a href="goods.php?id=51"><img alt="next" src="themes/test1/images/down.gif" /></a>
            </p>
      </div>
      <ul>
             <li class="clearfix">
      ...
      <li class="clearfix">
       <dd>
             <strong>上架时间：</strong>2015-03-17             </dd>
       <dd class="ddR">
      ...
      <li class="clearfix">
       ...
       <strong>用户评价：</strong>
      <img src="themes/test1/images/stars4.gif" alt="comment rank 4" />
       </dd>
      </li>
      ...
      <li class="padd">
      <a href="javascript:addToCart(52)"><img src="themes/test1/images/bnt_cat.gif" /></a>
      <a href="javascript:collect(52)"><img src="themes/test1/images/bnt_colles.gif" /></a>
            <a href="user.php?act=affiliate&goodsid=52"><img src='themes/test1/images/bnt_recommend.gif'></a>
            </li>
      </ul>
      </form>
     </div>
